...
def main():
    ...
    for i in range(len(actionsIfThen)):
        ...
        if actionsIfElse[i] != []:
            ...
            testIdentical(actionsIfThen[i][0], actionsIfElse[i][0], actionsIfThen[i][2], actionsIfElse[i][2],
                          actionsIfThen[i][1], actionsIfElse[i][1])
